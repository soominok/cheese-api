...
####################### 데이터 불러오기 & 생성 & featrue 제거 #######################
    ...
    def change_to_cheese(data, item_count):
        ...
        user_data_fin = user_data2.rename(columns={'Unnamed: 0_x': 'order_no', 'Unnamed: 0_y': 'cheese_code', 'brand': 'cheese_brand', 'name': 'cheese_name', 'price' : 'cheese_one_price', 'sub2_rank': 'cheese_rank', \
...
#         user_split = OrderDfo.user_data_split(this.user)
...
#         # show_age_plot = OrderDfo.find_requency(this.user, 'order_no', 'user_age') 
...
#         show_corr = OrderDfo.make_corr(this.train)

#         # this = OrderDfo.drop_feature(this, 'order_no')
#         this = OrderDfo.drop_feature(this, 'cheese_brand')
#         this = OrderDfo.drop_feature(this, 'cheese_code')
#         this = OrderDfo.drop_feature(this, 'cheese_name')
#         this = OrderDfo.drop_feature(this, 'cheese_types')

#         this = OrderDfo.drop_feature(this, 'cheese_rank')

#         this.label = OrderDfo.create_label(this) # payload
#         this.train = OrderDfo.create_train(this) # payload
